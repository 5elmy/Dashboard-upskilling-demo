...
//             Karthi Madesh
//           </h2>
//           <p className='my-1 text-gray-400'>{sessionStorage.getItem("email")}</p>
...
export default function SideNav() {
  const [activeMenuItem, setActiveMenuItem] = useState(localStorage.getItem('activeMenuItem') || 'home');

  useEffect(() => {
    // Store the active menu item in localStorage whenever it changes
