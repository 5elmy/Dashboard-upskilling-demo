...
//         <label htmlFor="" className="font-montserrat text-[14px] font-medium leading-[17.07px] text-left">Email</label>
//         <input onChange={loginForm.handleChange} onBlur={loginForm.handleBlur} name="email" placeholder="Enter your Email" className="border focus:outline-gray-300 border-gray-300 h-[44px] rounded-[4px] focus:border-none"/>
//        </div>
//        <div className="flex flex-col gap-3 my-3">
//         <label htmlFor="" className="font-montserrat text-[14px] font-medium leading-[17.07px] text-left">Password</label>
//         <input onChange={loginForm.handleChange} onBlur={loginForm.handleBlur} name="password" placeholder="Enter your Password" type="password" className="border focus:outline-gray-300 border-gray-300 h-[44px] rounded-[4px] focus:border-none"/>
//        </div>

//        <button className="uppercase bg-[#FEAF00] w-full h-[44px] rounded-[4px] text-white my-3">sign in </button>
//       </form>
//     </div>
//   );
// }
